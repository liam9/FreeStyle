...
from FindSongs_NLG import FindURLs_NLG
from ArtistStyle_NLG import ArtistStyle_NLG
...
def Generate_NLG(artist):
	...
	for k in range(0, len(URLs)-1):
		...
		#Start processing the Lyrics to the custom rap style
		Phrases = Style(artist, Lyrics)
